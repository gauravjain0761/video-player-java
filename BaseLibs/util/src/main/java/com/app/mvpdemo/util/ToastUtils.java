...
public class ToastUtils {
    ...
    public static void show(Context context, CharSequence message, int duration) {
        customToastGravity(context,message,duration, Gravity.CENTER,0,-160);
//        if (isShow){
//            if (mToast == null) {
...
//        }
    ...
    public static void show(Context context, int resId, int duration) {
        customToastGravity(context,resId,duration, Gravity.CENTER,0,0);
//        if (isShow){
//            if (mToast == null) {
...
//        }
     ...
     * @param yOffset
     */
    public static void customToastGravity(Context context,  int resId, int duration,int gravity, int xOffset, int yOffset) {
        if (isShow){
            if (mToast == null) {
                mToast = Toast.makeText(context, resId, duration);
            } else {
